 <%-- 
    Document   : channel_video
    Created on : Dec 19, 2021, 5:49:51 PM
    Author     : user
--%>
  ...
  <div class="row" >
             ...
             try{
                 ...
                 if(ra.next()){
                     ...
                     <table class="table table-borderless" >
                         <tr><td><h2 style="color:green"><strong><%=ra.getString("cname")%></strong></h2></td></tr>
                     </table>
                 </div>
    ...
    %>
           ...
           <tr>
               ...
               <td> <a href="edit_video.jsp?code=<%=rs.getString("code")%>&ccode=<%=code%>"><i class="fa fa-edit" style="font-size:25px;color:blue;cursor:pointer;"></i></a></td>
               <td>  <a href="delete_video.jsp?code=<%=rs.getString("code")%>&ccode=<%=code%>"><i class="fa fa-trash" style="font-size:25px;color:red;cursor:pointer;"></i></a></td>
           </tr>
                    <%
                 }
                 out.print("</table>");
