...
<div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                 ...
                 <li>
                    <a href="dashboard.jsp"> <i class="fa fa-dashboard"></i><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dashobaord</strong></a>  
                </li>
                ...
                <li>
                 ...
                 <%
                     ...
                     if(email!=null){
                          %>
                          <li>
                             <a href="#"> <i class="fa fa-user"></i><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;View Profile</strong></a>  
                         </li>
                          <%
                      }  
...
<%
                            ...
                            <%
                                 ...
                                 %>
                                 <li class="nav-item">
                                <a class="nav-link" href="logout.jsp" ><i class="fa fa-sign-out"><strong>Logout</strong></i></a>
                            </li>
                                 <%
                             }
                            %>                        </ul>
...
<div class="container-fluid">
    <div class="row w3-card">
       ...
       <div class="col-sm-2  " style="margin-top:20px">
            ...
            <img src="user/<%=rs.getString("code")%>.jpg" style="width:150px;height:150px;" class="img-fluid thumbnails ">
       </div>
        
        <div class="col-sm-8  " style="margin-top:20px">
            <table class="table table-borderless">
                <tr><td><strong><h3>First Name :</h3></strong></td><td><strong><h3><%=rs.getString("fname")%></h3></strong></td></tr>
                <tr><td><strong><h3>Last Name :</h3></strong></td><td><strong><h3><%=rs.getString("lname")%></h3></strong></td></tr>
