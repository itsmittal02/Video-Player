<%-- 
    Document   : mp4_video
    Created on : 11 Aug, 2022, 3:57:27 PM
...
<div class="container-fluid">
  <div class="row" >
       ...
       <div class="col-sm-8 w3-card">
           <h3><strong stryle="color:green"><center>Add Video Mp4</center></strong></h3>
		 <form method="post" ACTION="FileUploadProcess1.jsp?code=<%=code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
