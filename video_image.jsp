<%-- 
    ...
    Created on : 11 Aug, 2022, 3:47:44 PM
...
<div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                 ...
                 <li>
                    <a href="dashboard.jsp"> <i class="fa fa-home"></i><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dashobaord</strong></a>  
                </li>
...
<div class="container-fluid">
  <div class="row" >
       ...
       <div class="col-sm-8 w3-card">
           <h3><strong style="color:green"><center>Add Video Image</center></strong></h3>
		 <form method="post" ACTION="FileUploadProcess.jsp?code=<%=code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
