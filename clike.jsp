<%-- 
    Document   : clike
    Created on : Mar 13, 2022, 4:51:44 PM
    Author     : user
--%>
		   ...
		   try{
					 ...
					 if(request.getParameter("code")!=null && request.getParameter("ptr")!=null ){
						...
						Statement pr =cn.createStatement();
                                         ResultSet prs = pr.executeQuery("select * from cuserlike where email='"+email+"' AND code='"+code+"' ");
						if(prs.next()){
                                                     pattern= prs.getString("ptr");
                                                }
					   ...
					   PreparedStatement ps = cn.prepareStatement("insert into cuserlike values(?,?,?)");
                                    ...
                                    ResultSet rs1 = sm.executeQuery("select  count(*) from cuserlike where code='"+code+"' AND ptr='like'");
                                    if(rs1.next()){
