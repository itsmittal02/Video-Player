...
<div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#"> <i class="fa fa-history"></i><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;History</strong></a>  
                </li>
                <li>
...
<div class="container-fluid">
     <div class="col-sm-12" style="background-color:white;">
                     <table class="table table-borderless w3-card" >
                         <tr ><td> <h3   style="color:green"><strong ><center>History</center></strong></h3> </td></tr>
                     </table>
                 </div>
      ...
      <%
         ...
         while(rs1.next()){
             ...
             if(rs2.next()){
                 ...
                 <div class="col-sm-3 w3-card video-block" id="r-<%=rs1.getString("vcode")%>">
                              ...
                              <table class="table table-borderless">
                                  ...
                                  <tr  >
                                      <td><strong><%=rs2.getString("vtitle")%></strong></td><td><i   style="float:right;cursor:pointer;color:red;font-size: 25px;"class="fa fa-trash" rel="<%=rs1.getString("vcode")%>"></i></td>
                                  </tr>
                              </table>
