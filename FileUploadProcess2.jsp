<%-- 
    Document   : FileUploadProcess2
    Created on : Dec 21, 2021, 12:29:16 AM
    Author     : user
--%>
...
fileOut.flush();
fileOut.close();
response.sendRedirect("channel_video.jsp?code="+ccode+"&upload_success=1");
}catch (Exception e)
{

response.sendRedirect("channel_video.jsp?code="+ccode+"&upload_err=1");
}
}
 }
