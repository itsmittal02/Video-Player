<%-- 
    Document   : user_image
    Created on : Mar 6, 2022, 9:48:04 PM
    Author     : user
--%>
	 ...
	 <div class="wrapper"  >
        ...
        <nav id="sidebar" >
            ...
            <ul class="list-unstyled components">
                <p>SMplayer</p>
                <li>
                    <a href="index.jsp"> <i class="fa fa-home"></i><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Index</strong></a>  
                </li>
                <li>
...
<!-- Page Content  -->
  ...
  <div class="row" >
       ...
       <div class="col-sm-8 w3-card">
           <h3><strong style="color:green"><center>Add User Image</center></strong></h3>
		 <form method="post" ACTION="FileUploadProcess4.jsp?code=<%=code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
