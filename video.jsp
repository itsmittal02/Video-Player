  ...
  <div class="row" >
      <div class="col-sm-12"></div>
       <div class="col-sm-4 w3-card">
            ...
            <img src="profile/<%=ccode%>.jpg" class="img-fluid" style="width:300px;height:300px;">
       </div>
       <div class="col-sm-8 w3-card">	   
           <h3><strong><h2 style="color:green"><center> Add Video</center></h2></strong></h3>
            <form method="post" action="add_video.jsp?code=<%=ccode%>">
               <label><strong>Video Title:</strong></label>
               <input type="text" name="vtitle" class="form-control" required><br><br>
               <label><strong>Description:</strong></label>
               <textarea name="description" class="form-control" row="5" cols="5" required  style="resize:none;"></textarea><br><br>
