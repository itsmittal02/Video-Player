...
<div class="wrapper">
        ...
        <nav id="sidebar">
          ...
          <ul class="list-unstyled components">
                ...
                <li>
                    <a href="subscription_channel.jsp"> <i class="fa fa-envelope"></i><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Subscriptions</strong></a>  
                </li>
                <%
...
<div class="container-fluid">
  <div class="row" >
       ...
       <div class="col-sm-8 w3-card">	   
		 <form method="post" ACTION="FileUploadProcess5.jsp?code=<%=code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
