<%-- 
    ...
    Created on : 12 Aug, 2022, 10:27:37 AM
...
<div class="sidebar-header">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#"> <i class="fa fa-video-camera"></i><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Your Videos</strong></a>  
                </li>
...
<div class="container-fluid">
     <div class="col-sm-12" style="background-color:white;">
                     <table class="table table-borderless w3-card" >
                         <tr ><td> <h3   style="color:green"><strong ><center>Your Videos</center></strong></h3> </td></tr>
                     </table>
                 </div>
         ...
         while(rs1.next()){
                 ...
                 <div class="col-sm-3 w3-card video-block">
                              <table class="table table-borderless">
                                  ...
                                  <tr>
                                      <td><strong><%=rs1.getString("vtitle")%></strong></td> 
                                  </tr>
                              </table>
