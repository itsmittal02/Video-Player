...
<div class="sidebar-header">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#"><i   class="fa fa-heart"></i><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Favorite Videos</strong></a> 
                </li>
                <li>
...
<div class="container-fluid">
    <div class="col-sm-12" style="background-color:white;">
                     <table class="table table-borderless w3-card" >
                         <tr ><td> <h3   style="color:green"><strong ><center>Favourite Videos</center></strong></h3> </td></tr>
                     </table>
                 </div>
  ...
  <div class="row" >
      <%
         ...
         ResultSet rs1 = st1.executeQuery("select * from favourite  where email='"+email+"' order by rand()");
         while(rs1.next()){
             ...
             if(rs2.next()){
                 ...
                 <div class="col-sm-3 w3-card video-block">
                              <table class="table table-borderless">
                                  ...
                                  <tr>
                                      <td><strong><%=rs2.getString("vtitle")%></strong></td><td><i style="float:right;color:red;" class="fa fa-heart"></i></td>
                                  </tr>
                              </table>
