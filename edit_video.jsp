        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-header">
               <%
                    ...
                    ResultSet rs1 = st1.executeQuery("select * from youtube where email='"+email+"'");
                    if(rs1.next()){
                %>
                
                 <img src="user/<%=rs1.getString("code")%>.jpg" style="width:200px;height: 200px;"class="img-fluid rounded-circle thumbnails">
                <center> <p><strong style="color:white"><%=rs1.getString("fname")%>&nbsp;&nbsp;<%=rs1.getString("lname")%></strong></p></center>
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                 ...
                 <li>
                    <a href="fav_video.jsp"> <i class="fa fa-heart"></i><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;favourite Videos</strong></a>  
                </li>
                 <li>
       ...
       <div class="col-sm-8 w3-card">
           <h3><strong><center>Edit Video Title & Description</center></strong></h3>
             <form method="post" action="update_video.jsp?code=<%=code%>&ccode=<%=ccode%>">
               ...
               <input type="text" name="vtitle" value="<%=rs.getString("vtitle")%>" class="form-control" required><br><br>
               <label><strong>Description:</strong></label>
			   <textarea name="description" class="form-control"><%=rs.getString("description")%></textarea><br><br>
  ...
  <div class="row">
    ...
    <div class="col-sm-8 w3-card">
        <h3><strong><center>Change Video Image</center></strong></h3>
                   <form method="post" ACTION="FileUploadProcess2.jsp?code=<%=code%>&ccode=<%=ccode%>" name="uploadForm" ENCTYPE='multipart/form-data'>
  ...
  <div class="row"> 
    ...
    <div class="col-sm-8 w3-card">
        <h3><strong><center>Change Video Mp4</center></strong></h3>
              <form method="post" ACTION="FileUploadProcess3.jsp?code=<%=code%>&ccode=<%=ccode%>" name="uploadForm" ENCTYPE='multipart/form-data'>
